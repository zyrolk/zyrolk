          ...
          {product.stock > 0 ? (
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center py-2.5 px-2 bg-slate-900 text-white hover:bg-slate-800 rounded-xl text-xs font-semibold cursor-pointer transition-all"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center py-2.5 px-3 bg-brand-blue hover:bg-blue-700 text-white rounded-xl text-xs font-bold cursor-pointer transition-all gap-1.5 shadow-sm shadow-brand-blue/15"
            >
              <Phone className="h-3.5 w-3.5 text-white fill-white" />
